...
11. Заголовки должны быть компактными и не слишком крупными
 12. В конце добавь раздел "#### Рекомендации", 3–4 предложения с советами:
    - на что обратить внимание при дальнейшем изучении темы,
    - какие термины/аспекты стоит погуглить,
    - какие сумежные вопросы полезно посмотреть.
